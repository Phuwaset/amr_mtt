...
ARM_WAYPOINTS_DROP = [
    ...
    ("STEP_6_PLACE",  [1.5708, -2.8623, -0.2269, -1.0297, 1.5708, 0.0], 1.5),
    # 6. STEP 6 ท่าเตรียมวาง (รูป image_3415db.png)
    ("STEP_6_PLACE",  [1.5708, -2.6623, -0.2269, -1.0297, 1.5708, 0.0], 1.5),
    # 7. STEP 7 กลับท่า HOME จบงาน
